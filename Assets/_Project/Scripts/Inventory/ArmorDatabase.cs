...
public class Armor
{
	...
	public Armor(int id, string type, string title, int life, int mana, int attack, int magicAttack, int defense, int speed, int expToCap, string characterOwner, string description, int slotID)
	{
		this.ID = id;
        this.Type = type;
		this.Title = title;
        ...
        this.SlotID = slotID;
        this.Sprite = Resources.Load<Sprite>("Items/" + description);
